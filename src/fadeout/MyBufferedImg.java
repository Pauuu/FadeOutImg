...
public class MyBufferedImg extends BufferedImage {
    ...
    public void paint() {
        this.gr.drawImage(this, 800, 0, 700, 500, null);
    }
    ...
    private float[] calcularDiferenciaIaRasters(Raster rasImg, int numFrames) {
        ...
        Integer[] iaRasterOriginal = this.convertDataRasterToIntArray(rasImg);
        Integer[] iaRasterToFade = this.convertDataRasterToIntArray(this.getRaster());
